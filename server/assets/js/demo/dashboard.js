...
$(window).on('load', function() {
    ...
    var barEl2 = $("#demo-sparkline-area");
    var barValues2 = [70,62,56,67,87,45,47,30,53,78];
    var barValueCount2 = barValues2.length;
    var barSpacing = 1;
    var salesSparkline2 = function(){
    ...
    var earningSparkline = function(){
        $("#demo-sparkline-line").sparkline([345,404,305,455,378,345,404,305,455,378,345,404,305,455,378,345,404,305,455,378,345,404,305,455,378,345,404,305,455,378,], {
            type: 'line',
            width: '100%',
            height: '40',
            spotRadius: 4,
    ...
    var barValues = [70,62,56,67,87,45,47,30,36,26,12,9,34,23,18,15,18,10,8,9,12,2,5,14,20,26,30,32];
